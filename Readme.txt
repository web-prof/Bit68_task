...
2-as celery is used as an extra to provide some periodic tasks on redis-server
    ...
    **cosider using these commands on different cmd windows inaddion to the ordinary run_server cmd window:
...
notes:
1-all products objects are ordered using price as required on the tasks info
2-the local_settings.py file is created for testing purposes
